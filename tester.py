...
cur.execute('CREATE TABLE IF NOT EXISTS orders(orderid INT PRIMARY KEY, date, userid INT, total text); ')
conn.commit()
#
# cur.execute("""INSERT INTO users(userid, fname, lname, gender) VALUES('00001', 'Alex', 'Ivanchenko', 'male');""")
# conn.commit()
#
# user = ('00002', 'Vladimir', 'Gorbunov', 'male')
...
customers = [
  ...
  ('00017', 'Joe', 'Walsh', 'male'), ('00018', 'Reagan', 'Gorbunov', 'male'), ('00019', 'Aubree', 'Hogan', 'female'),
  ('00020', 'Avery', 'Floyd', 'male'), ('00021', 'Elianna', 'Gorbunov', 'female'), ('00022', 'Rodney', 'Stout', 'male'),
  ('00023', 'Elaine', 'Mcintosh', 'female'), ('00024', 'Myla', 'Parker', 'female'), ('00025', 'Alijah', 'Horn', 'female'),
...
# cur.execute("SELECT * FROM users WHERE lname='Gorbunov';")
# one_result = cur.fetchmany(1)
# print(one_result)
...
# def sql_update(conn):
#   cur.execute('UPDATE users SET fname = "Vladimir" where userid = 26')
#   conn.commit()
#
# # sql_update(conn)

#
# cur.execute("select * from users where fname='Vladimir'")
# print(cur.fetchall())
...
# print(cur.fetchall())
#
# cur.execute("DELETE FROM users WHERE lname='Gorbunov';")
# conn.commit()
# # # #
# cur.execute("select * from users where lname='Gorbunov'")
# print(cur.fetchall())
...
# conn.commit()
#
# cur.execute("""SELECT * FROM users WHERE userid between 20 and 27 AND lname like 'Gor%';""")
# res = cur.fetchall()
# for i in res:
#   print(i)